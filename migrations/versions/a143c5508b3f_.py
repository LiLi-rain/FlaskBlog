...
Revision ID: a143c5508b3f
Revises: 150ed85d01dd
Create Date: 2022-10-12 14:32:42.715721
...
revision = 'a143c5508b3f'
down_revision = '150ed85d01dd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', 'desc', 'url')
    )
